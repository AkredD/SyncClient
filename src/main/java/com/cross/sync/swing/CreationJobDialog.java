...
public class CreationJobDialog extends JDialog {
    ...
    private JComboBox providerFromBox;
    private JComboBox providerToBox;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    public CreationJobDialog(JDialog parent, Boolean modal) {
        super(parent, modal);
        this.parent = parent;
    ...
    private void formTransferAttrPanel() {
        ...
        ComboBoxModel providersModel = new DefaultComboBoxModel(providers);
        providerFromBox = new JComboBox(providersModel);
        providerFromBox.setEditable(false);
        providerToBox = new JComboBox(providersModel);
