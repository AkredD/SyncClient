...
public class TransferDialog extends JDialog {
    ...
    private DefaultListModel jobsModel = new DefaultListModel();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    public TransferDialog(Frame parent, Boolean modal) {
        super(parent, modal);
        ...
        deleteButton.addActionListener(e -> {
            if (jobsList.getSelectedValue() != null) {
                String transferName = (String) jobsList.getSelectedValue();
